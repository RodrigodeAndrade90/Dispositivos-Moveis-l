...
// NOVAS TELAS DE CURSOS
import ListaCursosScreen from './atividade/myapp/screens/ListaCursosScreen';
import CadastroCursoScreen from './atividade/myapp/screens/CadastroCursoScreen';
import EditarCursoScreen from './atividade/myapp/screens/EditarCursoScreen';
import TransferirAlunosScreen from './atividade/myapp/screens/TransferirAlunosScreen';
  ...
  return (
    <NavigationContainer theme={MyTheme}>
      ...
      >
        ...
        />
        <Stack.Screen 
          name="TransferirAlunos" 
          component={TransferirAlunosScreen} 
          options={{ title: 'Transferir Alunos' }}
        />
      </Stack.Navigator>
    </NavigationContainer>
  );
