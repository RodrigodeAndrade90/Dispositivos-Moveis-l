  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      <View style={styles.header}>
        <Text style={styles.headerTitle}>Novo Professor</Text>
        <Text style={styles.headerSubtitle}>Cadastre um novo professor no sistema</Text>
      </View>
      ...
      <View style={styles.form}>
        <View style={styles.inputGroup}>
          ...
          <View style={styles.inputContainer}>
            ...
            <TextInput 
              ...
              style={styles.input} 
              placeholder="Ex: Professor André Olímpio"
        ...
        <View style={styles.inputGroup}>
          <Text style={styles.label}>Titulação Acadêmica *</Text>
          <View style={styles.inputContainer}>
            <Ionicons name="ribbon-outline" size={20} color="#666" style={styles.inputIcon} />
            <TextInput 
              value={titulacao} 
          ...
          <Text style={styles.helperText}>
            Nível mais alto de formação acadêmica
          </Text>
        </View>
        ...
        <View style={styles.inputGroup}>
          ...
          <Text style={styles.helperText}>
            Tempo total de experiência em ensino
          </Text>
        </View>
        ...
        <View style={styles.summaryCard}>
          ...
          <View style={styles.summaryItem}>
            <Text style={styles.summaryLabel}>Titulação:</Text>
            <Text style={styles.summaryValue}>{titulacao || 'Não informado'}</Text>
          </View>
          <View style={styles.summaryItem}>
            <Text style={styles.summaryLabel}>Experiência:</Text>
            <Text style={styles.summaryValue}>
              {tempo ? `${tempo} anos` : 'Não informado'}
            </Text>
          </View>
        </View>
        ...
        <TouchableOpacity 
          style={[
            styles.saveButton,
            (!nome || !titulacao || !tempo) && styles.saveButtonDisabled
          ]}
          onPress={handleSalvar}
          disabled={!nome || !titulacao || !tempo || loading}
        >
          {loading ? (
